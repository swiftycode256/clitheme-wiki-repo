...
To use content variables, [enable](Available%20options#How%20to%20set%20options) the `substvar` option and use the `{{<Variable name>}}` syntax in content, such as `{{example_var}}`.
