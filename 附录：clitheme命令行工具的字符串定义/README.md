...
有关编写主题定义文件的信息，请参考[应用程序和字符串定义API/编写主题定义文件/基本用法](../应用程序和字符串定义API/编写主题定义文件/基本用法)。
...
CLItheme所有字符串定义的路径名称将采用以下开发者和应用名称，并且永远会以这些名称开头。详见[应用程序和字符串定义API/应用程序适配/路径名称和数据结构](../应用程序和字符串定义API/应用程序适配/1.%20路径名称和数据结构)。
